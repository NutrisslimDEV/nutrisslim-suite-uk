...
<?php 
	...
	if ( $order->has_status( 'pending' ) ){
		global $emailMSG; $emailMSG = __( 'The order has been created for you.', 'underStrap' ) . '<br>' .' <a href="' . esc_url( $order->get_checkout_payment_url() ) . '" style="color:#1fb25a">' . esc_html__( 'Pay for this order', 'woocommerce' ) . '</a>';
	}
