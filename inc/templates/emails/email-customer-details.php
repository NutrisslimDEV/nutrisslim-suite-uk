...
global $translation_language; __( 'Details zum Kunden', 'woocommerce' );
?>
<?php if ( ! empty( $fields ) ) : ?>
<div style="font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; margin-bottom: 40px;">
    <h2><?= apply_filters( 'wpml_translate_single_string', 'Customer details', 'woocommerce', 'Customer details', $translation_language ); ?>
    </h2>
    <ul>
