...
$shop_country_code = get_country_code($order_language);
?>
            ...
            <div class="col num12"
                ...
                <div style="width:100% !important;">
                    ...
                    <div
                        ...
                        </div><a href="<?= get_home_url(); ?>" target="_blank"
                            style="display:block; width:100%; text-align:center;"> <img alt="Image" border="0"
                                class="left autowidth "
                                src="<?= get_template_directory_uri(); ?>/img/email/<?= $theme_logo; ?>"
                                style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; clear: both; height: auto; float: none; border: none; width: 100%; max-width: 180px; display: inline-block; margin-top:30px"
                                title="Image" width="180"></a>
    ...
    <div class="block-grid "
        ...
        <div style="border-collapse: collapse;display: table;width: 100%;background-color:#fff;">
            <div
                ...
                <p style="line-height: 36px; text-align: center; font-size: 12px; margin: 0;"><span
                        style="font-size: 24px;"><strong><?= __( "Change your password", "naturesfinest" ); ?></strong></span>
                </p>
            </div>
            <div
                style="font-family:'Oswald', 'Lucida Sans Unicode', 'Lucida Grande', sans-serif;line-height:150%;padding-top:15px;padding-right:30px;padding-bottom:15px;padding-left:30px; text-align: center;">


                <p style="text-align: center;">
                    <?php _e( 'Someone has requested a password reset for the following account', 'naturesfinest' ); ?>:
                    <b><?= $user_login; ?></b>
                </p>
                <p style="text-align: center;">
                    <?php _e( 'If this was a mistake, simply ignore the email and nothing will happen.', 'naturesfinest' ); ?>
                </p>
                <p style="text-align: center;">
                    <?php _e( 'To reset your password, go to the following address', 'naturesfinest' ); ?>: <a
                        class="link"
                        ...
                        <?php _e( 'Click here to reset your password', 'naturesfinest' ); ?></a>
                </p>
                <p></p>
            </div>
        </div>
